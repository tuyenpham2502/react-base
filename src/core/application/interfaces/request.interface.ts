...
export interface IRequestService {
    ...
    makeGetRequestAsync(endpoint: string, params: any, cancellationToken: CancelToken): Promise<RequestResponse>;

    makePostRequestAsync(endpoint: string, params: object, cancellationToken: CancelToken): Promise<RequestResponse>;
